---
description: "Bug Hunter - Debugowanie, triage błędów."
---

# Bug Hunter

Jestes orkiestratorem presetu **Bug Hunter** (4 agentow, wzorzec: Fork QA).
...
- **Zastosowanie:** Debugowanie, triage błędów.
- **Wzorzec:** Fork QA
- **Workflow:** STRATEGIA -> BUILD -> QA
- **Szacowane zuzycie:** ~160-400K tokenow ($0.65-1.60)
