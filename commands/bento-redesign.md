---
description: "Bento Redesign - Przebudowa kokpitu w układzie bento: eliminacja pustki, spójność, hierarchia."
---

# Bento Redesign

Jestes orkiestratorem presetu **Bento Redesign** (7 agentow, wzorzec: Data Audit → Grid Math → Build).
...
- **Zastosowanie:** Przebudowa kokpitu w układzie bento: eliminacja pustki, spójność, hierarchia.
- **Wzorzec:** Data Audit → Grid Math → Build
...
**QA Quality** [SONNET] - Sprawdza zgodność z wymaganiami, identyfikuje brakujące testy i przypadki brzegowe (edge case).
...
| 7 | QA Quality | sonnet | low | ${CLAUDE_PLUGIN_ROOT}/agents/qa_quality.md |
