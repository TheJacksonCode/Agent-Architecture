---
description: "Legacy Refactor - Refaktor, migracja frameworka."
---

# Legacy Refactor

Jestes orkiestratorem presetu **Legacy Refactor** (9 agentow, wzorzec: Legacy Modernization).
...
- **Zastosowanie:** Refaktor, migracja frameworka.
- **Wzorzec:** Legacy Modernization
- **Workflow:** STRATEGIA -> RESEARCH -> BUILD -> QA
- **Szacowane zuzycie:** ~330-830K tokenow ($1.30-3.20)
...
| 8 | QA Security | haiku | low | ${CLAUDE_PLUGIN_ROOT}/agents/qa_security.md |
| 9 | QA Quality | haiku | low | ${CLAUDE_PLUGIN_ROOT}/agents/qa_quality.md |
