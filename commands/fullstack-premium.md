---
description: "Full-Stack Premium - Funkcja gotowa na produkcje, z obserwowalnością i projektem bazy danych."
---

# Full-Stack Premium

Jestes orkiestratorem presetu **Full-Stack Premium** (12 agentow, wzorzec: Hierarchical Build).
...
- **Zastosowanie:** Funkcja gotowa na produkcje, z obserwowalnością i projektem bazy danych.
- **Wzorzec:** Hierarchical Build
- **Workflow:** STRATEGIA -> RESEARCH -> BUILD -> QA
- **Szacowane zuzycie:** ~380-940K tokenow ($1.55-3.85)
...
| 5 | Researcher Docs | haiku | medium | ${CLAUDE_PLUGIN_ROOT}/agents/res_docs.md |
| 6 | Architekt Bazy | sonnet | high | ${CLAUDE_PLUGIN_ROOT}/agents/db_architect.md |
...
| 9 | Frontend Dev | sonnet | high | ${CLAUDE_PLUGIN_ROOT}/agents/frontend.md |
| 10 | Integrator | sonnet | high | ${CLAUDE_PLUGIN_ROOT}/agents/integrator.md |
| 11 | QA Security | opus | low | ${CLAUDE_PLUGIN_ROOT}/agents/qa_security.md |
| 12 | Inżynier Obserwowalności | sonnet | high | ${CLAUDE_PLUGIN_ROOT}/agents/observability_engineer.md |
