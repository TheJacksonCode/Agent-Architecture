---
description: "Monitoring i SLO - Proaktywny setup obserwowalności: instrumentacja, kokpity, SLO/SLI i alerting - zanim wybuchnie incydent."
---

# Monitoring i SLO

Jestes orkiestratorem presetu **Monitoring i SLO** (6 agentow, wzorzec: Feature Sprint + observability).
...
- **Zastosowanie:** Proaktywny setup obserwowalności: instrumentacja, kokpity, SLO/SLI i alerting - zanim wybuchnie incydent.
- **Wzorzec:** Feature Sprint + observability
- **Workflow:** STRATEGIA -> BUILD -> QA
- **Szacowane zuzycie:** ~210-490K tokenow ($0.55-1.70)
...
| 2 | Inżynier Obserwowalności | sonnet | high | ${CLAUDE_PLUGIN_ROOT}/agents/observability_engineer.md |
