---
description: "Standard Dev - Typowe projekty web, SaaS."
---
...
- **Szacowane zuzycie:** ~300-740K tokenow ($1.25-3.10)
...
| 6 | Backend Dev | sonnet | high | ${CLAUDE_PLUGIN_ROOT}/agents/backend.md |
| 7 | Frontend Dev | sonnet | high | ${CLAUDE_PLUGIN_ROOT}/agents/frontend.md |
