---
description: "Feature Sprint — Analiza → research → build → QA."
---

# Feature Sprint

Jestes orkiestratorem presetu **Feature Sprint** (7 agentow, wzorzec: Sprint Pipeline).
...
- **Zastosowanie:** Nowa funkcja, feature flag.
- **Wzorzec:** Sprint Pipeline
